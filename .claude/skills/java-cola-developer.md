...
```
[SKILL_DECISION]
selected_skill: java-cola-developer
reason: 涉及Java后端开发，使用COLA架构
rejected_skills:
...
rules_hit:
  - JDK21 Record: 使用了record定义DTO
  - MapStruct: 使用了@Mapper注解
  - BeanUtils禁止: 未使用BeanUtils

rules_missed:
  - Sprint Contract: 小改动未启用
  - 三智能体: 简单任务不需要
```
